    ...
    qfs.list(self.parentFolder).then(function(files) {
      ...
      files.forEach(function(d) {
        ...
        var dirPath = qfs.join(self.parentFolder, d)
          ...
          , function(err) {
            //if the session-info file could not be read, just show a warning
            util.log('REAP: ' + err + ' this folder will be ignored. If it should be reaped, please do it manually.');
            return;
          }).done();
      });
    });
